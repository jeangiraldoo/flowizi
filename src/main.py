...
subparser_system.set_defaults(func = system.show_system_info_command)
...
subparser_add.set_defaults(func = lambda args: add.add_command(args, subparser_add))
...
subparser_list.set_defaults(func = lambda args: list.list_command(subparser_list, args))
...
subparser_remove.set_defaults(func = lambda args: remove.remove_command(args, subparser_remove))
...
subparser_start_meeting.set_defaults(func = lambda args: start.start_command(args, subparser_start_meeting))
...
subparser_record.set_defaults(func = lambda args: record.record_command(args, subparser_record))
