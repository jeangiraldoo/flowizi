...
from gui.views.states import GuiState
from gui.views.components.ui import SidebarWidget, ToolbarWidget, TabWidget, GridWidget
...
class View(QMainWindow):
    ...
    def __init__(self):
        ...
        self._initUI()
        self.view_state = GuiState(ElemType.ENV, self.grid_widget)
    ...
    def get_clicked_elem_pos(self) -> int | None:
        """
        Retrieves the position of the currently clicked element.

        Returns:
            int | None: The position of the clicked label if a label is clicked; 
                        otherwise, None.
        """
